...
/**
 * ElderCare Connect brand mark.
 * Combines a protective heart (care + family) with a soft pulse line (healthcare/tech).
 * Pure SVG — scales cleanly from favicon to app icon.
 */
export function BrandIcon({
    ...
    return (
        ...
        >
            <defs>
                <linearGradient id="ec-brand-grad" x1="0" y1="0" x2="64" y2="64" gradientUnits="userSpaceOnUse">
