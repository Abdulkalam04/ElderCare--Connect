...
/**
 * Records activity inside ElderCare Connect for care-recipient accounts.
 * A website cannot inspect activity across the user's entire phone, so this
 * heartbeat deliberately measures only use of this application.
 */
