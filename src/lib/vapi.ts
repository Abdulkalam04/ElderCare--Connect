...
// Some bundlers expose the CJS default under `.default` — normalize.
const Vapi: typeof VapiImport =
  (VapiImport as unknown as { default?: typeof VapiImport }).default ?? VapiImport;

const publicKey = import.meta.env.VITE_VAPI_PUBLIC_KEY as string | undefined;

type VapiInstance = InstanceType<typeof VapiImport>;
let _vapi: VapiInstance | null = null;
 ...
 */
export function getVapi(): VapiInstance | null {
  if (!publicKey) {
